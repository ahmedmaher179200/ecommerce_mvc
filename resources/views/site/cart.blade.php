                                ...
                                @if (session()->has('cartItems'))
                                    @foreach (session()->get('cartItems') as $cartItem)
                                        <tr class="table_row">
                                            ...
                                            <td class="column-3">${{$cartItem['price'] - $cartItem['discount']['value']}}</td>
                                            <td class="column-4">
                                                <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                    <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m decrement" data-product_id="{{$cartItem['id']}}">
                                                        <i class="fs-16 zmdi zmdi-minus"></i>
                                                    </div>

                                                    <input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="{{$cartItem['quantity']}}">

                                                    <div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m increment" data-product_id="{{$cartItem['id']}}">
